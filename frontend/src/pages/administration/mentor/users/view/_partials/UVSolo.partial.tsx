                ...
                <RenderIf
                    ...
                    elementFalse={
                        <>
                            ...
                            <RenderIf
                                truthValue={user?.user_solo?.vateud_solo_id == null}
                                elementTrue={<span className="text-danger flex text-xs mt-4">Die Solo konnte nicht bei VATEUD Core eingetragen werden.</span>}
                            />
                            <Separator />
