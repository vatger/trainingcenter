...
import { TRAINING_STATIONS_TABLE_ATTRIBUTES, TRAINING_STATIONS_TABLE_NAME } from "../../db/migrations/20221115171252-create-training-stations-table";
...
TrainingStation.init(TRAINING_STATIONS_TABLE_ATTRIBUTES, {
